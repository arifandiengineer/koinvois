...
class UpdateEstimatePhotoUseCase @Inject constructor(
    private val repository: EstimateRepository
) {
    suspend operator fun invoke(estimatePhoto: EstimatePhoto) = repository.updateEstimatePhoto(estimatePhoto)
}