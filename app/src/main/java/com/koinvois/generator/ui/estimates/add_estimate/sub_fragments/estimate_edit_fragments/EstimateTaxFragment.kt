...
class EstimateTaxFragment : Fragment() {

    private var binding: FragmentEstimateTaxBinding? = null
    ...
    override fun onCreateView(
        ...
        binding = FragmentEstimateTaxBinding.inflate(inflater, container, false)
