...
class ItemDetailForEstimateActivity : BaseActivity<FragmentItemDetailForEstimateBinding>() {
    ...
    private suspend fun saveOnBack() {
        with(binding) {
            ...
            if (editItemDescription.text?.isNotEmpty() == true) {
                ...
                Toast.makeText(this@ItemDetailForEstimateActivity, getString(R.string.error_enter_item_name), Toast.LENGTH_SHORT).show()
            }
        }
        viewModel.currentEstimateItem = null
        finish()
    ...
    companion object {
        ...
        fun newIntent(context: Context, itemType: String): Intent =
            Intent(context, ItemDetailForEstimateActivity::class.java).apply {
