...
@AndroidEntryPoint
class SignatureActivity : BaseActivity<FragmentSignatureBinding>(), SignatureView.OnSignedListener {
    ...
    companion object {
        fun newIntent(context: Context): Intent = Intent(context, SignatureActivity::class.java)
    }
}
