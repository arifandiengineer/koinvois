        ...
        htmlContent.append(
            String.format(
                "<!DOCTYPE html>\n" +
                        ...
                        "            <p class=\"invoiceWord\">INVOICE</p>\n" +
                        "        </div>\n" +
                        "    </header>\n" +
                        "    <header>\n" +
                        "        <div class=\"mainWrapper\">\n" +
                        "            <h2 class=\"font-size\" style=\"margin:1px;\"> Invoice to:</h2>\n" +
                        "<div class=\"subhead\">" +
                        "<div >" +
                        "<article>" +
                        ...
                        "                <div style=\"margin: 0;\">\n" +
                        "                    <div class=\"ivnum\">\n" +
                        "                        <h3 class=\"font-size\" >Invoice# </h3>\n" +
                        "                        <p>${viewModel.invoiceNumber ?: ""}</p>\n" +
                        "                    </div>\n" +
                        "                    <div class=\"ivnum\">\n" +
                        "                        <h3 class=\"font-size\">Date </h3>\n" +
                        "                        <p>${viewModel.invoiceDate ?: ""}</p>\n" +
                        "                    </div>\n" +
                        "                </div>\n" +
                        "            </div>\n" +
                        "    </header>\n" +
            ...
            viewModel.selectedItemsList?.withIndex()?.forEach {
                if (it.index % 2 == 0) {
                    htmlContent.append(
                        "                <tr>\n" +
                                "                    <td>${it.index}</td>\n" +
                                "                    <td>${it.value.invoiceItemName}</td>\n" +
                                "                    <td>\$${it.value.invoiceItemUnitCost}</td>\n" +
                                "                    <td>${it.value.invoiceItemQuantity}</td>\n" +
...
//bottom content
        htmlContent.append(
            "    <header>\n" +
                    ...
                    "                        <p>\n" +
                    "                           Make this payment by ${viewModel.invoiceDueDate ?: ""}" +
                    "                        </p>\n" +
                    "                    </article>\n" +
                    "                </div>\n" +
                    "                <div style=\"margin: 0;\">\n" +
        ...
        htmlContent.append(
            "    <header>\n" +
                    ...
                    "                        <p>\n" +
                    "                            ${viewModel.invoicePaymentInstructions ?: ""}<br>\n" +
                    "                        </p>\n" +
                    "                    </article>\n" +
                    "                </div>\n" +
                    "            </div>\n" +
                    ...
                    "                <div class=\"total\">\n" +
                    "                    <span>Total </span>\n" +
                    "                    <span >${viewModel.invoiceTotal ?: ""}</span>\n" +
                    "                </div>\n" +
                    "            </div>\n"
        )
//photos section
        if (viewModel.photosForInvoice?.isNotEmpty() == true) {
            htmlContent.append(
                "            <div class=\"imgs-section\">\n"
            )

            viewModel.photosForInvoice?.forEach {
                Log.e("photo", utility.encodeToBase64(it.invoicePhoto).toString())

                htmlContent.append(
                    "                <div >\n" +
                            "                    <article>\n" +
                            "                        <h4 class=\"img-heading\" >${it.invoicePhotoDescription}</h4>\n" +
                            "                        <p style=\"margin-bottom: 4px\">\n" +
                            "                            ${it.invoicePhotoAdditionalDetails}\n" +
                            "                        </p>\n" +
                            "                        <img src=\"data:image/bmp;base64,${
                                utility.encodeToBase64(it.invoicePhoto).toString()
        ...
        viewModel.signatureObj?.signatureBitmap?.let {
            htmlContent.append(
                "    <footerbody>\n" +
                        ...
                        "                <div class=\"signword\">\n" +
                        "                    <img src=\"data:image/bmp;base64,${
                            utility.encodeToBase64(
                                viewModel.signatureObj?.signatureBitmap
                            ) ?: ""
