...
import com.koinvois.generator.databinding.FragmentInvoiceOutstandingBinding
...
class OutstandingInvoices : Fragment() {
    ...
    var binding: FragmentInvoiceOutstandingBinding? = null
    ...
    override fun onCreateView(
        ...
        binding = FragmentInvoiceOutstandingBinding.inflate(inflater, container, false)
